...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "anywheresoftware.b4a.samples.serial.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", anywheresoftware.b4a.samples.serial.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public anywheresoftware.b4a.samples.serial.b4xfloattextfield _searchfield = null;
...
_searchfield = new anywheresoftware.b4a.samples.serial.b4xfloattextfield();
...
__c.LogImpl("921299233","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(anywheresoftware.b4a.samples.serial.b4xsearchtemplate parent,anywheresoftware.b4a.samples.serial.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
anywheresoftware.b4a.samples.serial.b4xsearchtemplate parent;
