...
public class gauge extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "anywheresoftware.b4a.samples.serial.gauge");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", anywheresoftware.b4a.samples.serial.gauge.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_AnimateValueTo(anywheresoftware.b4a.samples.serial.gauge parent,float _newvalue) {
this.parent = parent;
this._newvalue = _newvalue;
}
anywheresoftware.b4a.samples.serial.gauge parent;
float _newvalue;
long _n = 0L;
int _duration = 0;
float _start = 0f;
...
//C
this.state = 1;
 //BA.debugLineNum = 224;BA.debugLine="Dim n As Long = DateTime.Now";
_n = parent.__c.DateTime.getNow();
 //BA.debugLineNum = 225;BA.debugLine="Dim duration As Int = Abs(mCurrentValue - NewValu";
_duration = (int) (parent.__c.Abs(parent._mcurrentvalue-_newvalue)/(double)100*parent._durationfromzeroto100+1000);
 //BA.debugLineNum = 226;BA.debugLine="Dim start As Float = mCurrentValue";
_start = parent._mcurrentvalue;
 //BA.debugLineNum = 227;BA.debugLine="mCurrentValue = NewValue";
parent._mcurrentvalue = _newvalue;
 //BA.debugLineNum = 228;BA.debugLine="Dim tempValue As Float";
_tempvalue = 0f;
 //BA.debugLineNum = 229;BA.debugLine="Do While DateTime.Now < n + duration";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 230;BA.debugLine="tempValue = ValueFromTimeEaseInOut(DateTime.Now";
_tempvalue = parent._valuefromtimeeaseinout((float) (parent.__c.DateTime.getNow()-_n),_start,(float) (_newvalue-_start),_duration);
 //BA.debugLineNum = 231;BA.debugLine="DrawIndicator(tempValue)";
parent._drawindicator(_tempvalue);
 //BA.debugLineNum = 232;BA.debugLine="Sleep(10)";
...
this.state = 4;
;
 //BA.debugLineNum = 233;BA.debugLine="If NewValue <> mCurrentValue Then Return 'will h";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 235;BA.debugLine="DrawIndicator(mCurrentValue)";
...
_cvsindicator.Resize((float) (_width),(float) (_height));
 //BA.debugLineNum = 90;BA.debugLine="DrawBackground";
_drawbackground();
...
_mcallback = new Object();
 //BA.debugLineNum = 19;BA.debugLine="Private mBase As B4XView";
_mbase = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private xui As XUI";
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
 //BA.debugLineNum = 21;BA.debugLine="Private cvsGauge, cvsIndicator As B4XCanvas";
_cvsgauge = new anywheresoftware.b4a.objects.B4XCanvas();
_cvsindicator = new anywheresoftware.b4a.objects.B4XCanvas();
 //BA.debugLineNum = 22;BA.debugLine="Private mlbl As B4XView";
_mlbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Type GaugeRange (LowValue As Float, HighValue As";
;
 //BA.debugLineNum = 24;BA.debugLine="Private mRanges As List";
_mranges = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 25;BA.debugLine="Private GaugePanel, IndicatorPanel As B4XView";
...
_indicatorpanel = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private Radius, x, y As Float";
_radius = 0f;
_x = 0f;
_y = 0f;
 //BA.debugLineNum = 27;BA.debugLine="Private IndicatorLength As Int";
_indicatorlength = 0;
 //BA.debugLineNum = 28;BA.debugLine="Private CenterColor, IndicatorColor As Int";
_centercolor = 0;
_indicatorcolor = 0;
 //BA.debugLineNum = 29;BA.debugLine="Private MinValue, MaxValue As Float";
_minvalue = 0f;
_maxvalue = 0f;
 //BA.debugLineNum = 30;BA.debugLine="Private IndicatorBaseWidth As Float";
_indicatorbasewidth = 0f;
 //BA.debugLineNum = 31;BA.debugLine="Private mCurrentValue As Float";
_mcurrentvalue = 0f;
 //BA.debugLineNum = 32;BA.debugLine="Private PrefixText, SuffixText As String";
_prefixtext = "";
_suffixtext = "";
 //BA.debugLineNum = 33;BA.debugLine="Private DurationFromZeroTo100 As Int";
_durationfromzeroto100 = 0;
 //BA.debugLineNum = 34;BA.debugLine="Private HALF_CIRCLE = 1, FULL_CIRCLE = 2 As Int";
_half_circle = (int) (1);
_full_circle = (int) (2);
 //BA.debugLineNum = 35;BA.debugLine="Private GaugeType As Int";
_gaugetype = 0;
 //BA.debugLineNum = 36;BA.debugLine="Private AngleRange As Int";
_anglerange = 0;
 //BA.debugLineNum = 37;BA.debugLine="Private AngleOffset As Int";
_angleoffset = 0;
 //BA.debugLineNum = 38;BA.debugLine="Private BackgroundColor As Int";
_backgroundcolor = 0;
 //BA.debugLineNum = 39;BA.debugLine="Private textcolor As Int";
_textcolor = 0;
 //BA.debugLineNum = 40;BA.debugLine="Private textsize As Float";
_textsize = 0f;
...
_anglerange = (int) (270);
 //BA.debugLineNum = 143;BA.debugLine="IndicatorBaseWidth = 8dip";
_indicatorbasewidth = (float) (__c.DipToCurrent((int) (8)));
...
_anglerange = (int) (180);
 //BA.debugLineNum = 134;BA.debugLine="IndicatorBaseWidth = 6dip";
_indicatorbasewidth = (float) (__c.DipToCurrent((int) (6)));
 //BA.debugLineNum = 135;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.samples.serial.gauge._gaugerange  _createrange(float _lowvalue,float _highvalue,int _color) throws Exception{
anywheresoftware.b4a.samples.serial.gauge._gaugerange _r = null;
 //BA.debugLineNum = 205;BA.debugLine="Public Sub CreateRange(LowValue As Float, HighValu";
 //BA.debugLineNum = 206;BA.debugLine="Dim r As GaugeRange";
_r = new anywheresoftware.b4a.samples.serial.gauge._gaugerange();
 //BA.debugLineNum = 207;BA.debugLine="r.Initialize";
_r.Initialize();
 //BA.debugLineNum = 208;BA.debugLine="r.LowValue = LowValue";
_r.LowValue /*float*/  = _lowvalue;
 //BA.debugLineNum = 209;BA.debugLine="r.HighValue = HighValue";
_r.HighValue /*float*/  = _highvalue;
 //BA.debugLineNum = 210;BA.debugLine="r.Color = Color";
_r.Color /*int*/  = _color;
 //BA.debugLineNum = 211;BA.debugLine="Return r";
if (true) return _r;
...
float _lblheight = 0f;
 ...
 //BA.debugLineNum = 51;BA.debugLine="IndicatorLength = DipToCurrent(Props.Get(\"Indicat";
_indicatorlength = __c.DipToCurrent((int)(BA.ObjectToNumber(_props.Get((Object)("IndicatorLength")))));
 //BA.debugLineNum = 52;BA.debugLine="CenterColor = xui.PaintOrColorToColor(Props.Get(\"";
_centercolor = _xui.PaintOrColorToColor(_props.Get((Object)("CenterColor")));
 //BA.debugLineNum = 53;BA.debugLine="IndicatorColor = xui.PaintOrColorToColor(Props.Ge";
_indicatorcolor = _xui.PaintOrColorToColor(_props.Get((Object)("IndicatorColor")));
 //BA.debugLineNum = 54;BA.debugLine="BackgroundColor = xui.PaintOrColorToColor(Props.G";
_backgroundcolor = _xui.PaintOrColorToColor(_props.GetDefault((Object)("BackgroundColor"),(Object)(_xui.Color_White)));
 //BA.debugLineNum = 55;BA.debugLine="Dim m As Map = CreateMap(\"Half Circle\": HALF_CIRC";
_m = new anywheresoftware.b4a.objects.collections.Map();
_m = __c.createMap(new Object[] {(Object)("Half Circle"),(Object)(_half_circle),(Object)("Full Circle"),(Object)(_full_circle)});
 //BA.debugLineNum = 56;BA.debugLine="GaugeType = m.Get(Props.GetDefault(\"GaugeType\", \"";
_gaugetype = (int)(BA.ObjectToNumber(_m.Get(_props.GetDefault((Object)("GaugeType"),(Object)("Half Circle")))));
 //BA.debugLineNum = 57;BA.debugLine="MinValue = Props.Get(\"MinValue\")";
_minvalue = (float)(BA.ObjectToNumber(_props.Get((Object)("MinValue"))));
 //BA.debugLineNum = 58;BA.debugLine="MaxValue = Props.Get(\"MaxValue\")";
_maxvalue = (float)(BA.ObjectToNumber(_props.Get((Object)("MaxValue"))));
 //BA.debugLineNum = 59;BA.debugLine="mCurrentValue=Props.Get(\"CurrentValue\")";
_mcurrentvalue = (float)(BA.ObjectToNumber(_props.Get((Object)("CurrentValue"))));
 //BA.debugLineNum = 60;BA.debugLine="PrefixText = Props.Get(\"PrefixText\")";
_prefixtext = BA.ObjectToString(_props.Get((Object)("PrefixText")));
 //BA.debugLineNum = 61;BA.debugLine="SuffixText = Props.Get(\"SuffixText\")";
_suffixtext = BA.ObjectToString(_props.Get((Object)("SuffixText")));
 //BA.debugLineNum = 62;BA.debugLine="DurationFromZeroTo100 = Props.Get(\"Duration\")";
_durationfromzeroto100 = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 63;BA.debugLine="textcolor= xui.PaintOrColorToColor(Props.GetDefau";
_textcolor = _xui.PaintOrColorToColor(_props.GetDefault((Object)("TextColor"),(Object)(_xui.Color_White)));
 //BA.debugLineNum = 64;BA.debugLine="textsize=Props.Get(\"TextSize\")";
_textsize = (float)(BA.ObjectToNumber(_props.Get((Object)("TextSize"))));
 //BA.debugLineNum = 65;BA.debugLine="mBase = Base";
_mbase = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_base));
 //BA.debugLineNum = 66;BA.debugLine="Dim NativeFont As Object";
_nativefont = new Object();
 //BA.debugLineNum = 67;BA.debugLine="NativeFont = Typeface.LoadFromAssets(\"Crysta.ttf\"";
...
_mlbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
 //BA.debugLineNum = 75;BA.debugLine="mlbl.Font = xui.CreateFont( NativeFont, textsize)";
_mlbl.setFont(_xui.CreateFont((android.graphics.Typeface)(_nativefont),_textsize));
 //BA.debugLineNum = 76;BA.debugLine="mlbl.SetTextAlignment(\"CENTER\", \"CENTER\")";
_mlbl.SetTextAlignment("CENTER","CENTER");
 //BA.debugLineNum = 77;BA.debugLine="mlbl.TextColor =textcolor";
_mlbl.setTextColor(_textcolor);
...
anywheresoftware.b4a.samples.serial.gauge._gaugerange _gr = null;
anywheresoftware.b4a.objects.B4XCanvas.B4XPath _p = null;
float _startangle = 0f;
 //BA.debugLineNum = 99;BA.debugLine="Private Sub DrawBackground";
 //BA.debugLineNum = 100;BA.debugLine="cvsGauge.ClearRect(cvsGauge.TargetRect)";
_cvsgauge.ClearRect(_cvsgauge.getTargetRect());
 //BA.debugLineNum = 101;BA.debugLine="Select GaugeType";
switch (BA.switchObjectToInt(_gaugetype,_half_circle,_full_circle)) {
case 0: {
 //BA.debugLineNum = 103;BA.debugLine="ConfigureHalfCircle";
_configurehalfcircle();
 break; }
case 1: {
 //BA.debugLineNum = 105;BA.debugLine="ConfigureFullCircle";
_configurefullcircle();
 break; }
}
;
 //BA.debugLineNum = 107;BA.debugLine="cvsGauge.DrawCircle(x, y, Radius + 1dip, Backgrou";
_cvsgauge.DrawCircle(_x,_y,(float) (_radius+__c.DipToCurrent((int) (1))),_backgroundcolor,__c.True,(float) (0));
 //BA.debugLineNum = 108;BA.debugLine="For Each gr As GaugeRange In mRanges";
{
...
_gr = (anywheresoftware.b4a.samples.serial.gauge._gaugerange)(group9.Get(index9));
 //BA.debugLineNum = 109;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 110;BA.debugLine="Dim StartAngle As Float = ValueToAngle(gr.LowVal";
_startangle = _valuetoangle(_gr.LowValue /*float*/ );
 //BA.debugLineNum = 111;BA.debugLine="p.InitializeArc(x, y, Radius, StartAngle, ValueT";
_p.InitializeArc(_x,_y,_radius,_startangle,(float) (_valuetoangle(_gr.HighValue /*float*/ )-_startangle));
 //BA.debugLineNum = 112;BA.debugLine="cvsGauge.ClipPath(p)";
_cvsgauge.ClipPath(_p);
 //BA.debugLineNum = 113;BA.debugLine="cvsGauge.DrawCircle(x, y, Radius, gr.Color, True";
_cvsgauge.DrawCircle(_x,_y,_radius,_gr.Color /*int*/ ,__c.True,(float) (0));
 //BA.debugLineNum = 114;BA.debugLine="cvsGauge.RemoveClip";
_cvsgauge.RemoveClip();
 }
};
 //BA.debugLineNum = 116;BA.debugLine="cvsGauge.DrawCircle(x, y, Radius - IndicatorLengt";
_cvsgauge.DrawCircle(_x,_y,(float) (_radius-_indicatorlength),_backgroundcolor,__c.True,(float) (0));
 //BA.debugLineNum = 117;BA.debugLine="If GaugeType = FULL_CIRCLE And PrefixText <> \"\" T";
if (_gaugetype==_full_circle && (_prefixtext).equals("") == false) { 
 //BA.debugLineNum = 118;BA.debugLine="cvsGauge.DrawText(PrefixText, x, y - 30dip, xui.";
_cvsgauge.DrawText(ba,_prefixtext,_x,(float) (_y-__c.DipToCurrent((int) (30))),_xui.CreateDefaultFont((float) (16)),_textcolor,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 };
 //BA.debugLineNum = 121;BA.debugLine="cvsGauge.DrawCircle(x, y, Radius + 1dip, CenterCo";
_cvsgauge.DrawCircle(_x,_y,(float) (_radius+__c.DipToCurrent((int) (1))),_centercolor,__c.False,(float) (__c.DipToCurrent((int) (1))));
...
String _s = "";
 //BA.debugLineNum = 168;BA.debugLine="Private Sub DrawIndicator (Value As Float)";
 //BA.debugLineNum = 169;BA.debugLine="cvsIndicator.ClearRect(cvsIndicator.TargetRect)";
_cvsindicator.ClearRect(_cvsindicator.getTargetRect());
 //BA.debugLineNum = 170;BA.debugLine="Dim angle As Float = ValueToAngle(Value)";
_angle = _valuetoangle(_value);
 //BA.debugLineNum = 171;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 172;BA.debugLine="p.Initialize( x + (IndicatorBaseWidth-4dip) * Sin";
_p.Initialize((float) (_x+(_indicatorbasewidth-__c.DipToCurrent((int) (4)))*__c.SinD(_angle)),(float) (_y-(_indicatorbasewidth-__c.DipToCurrent((int) (4)))*__c.CosD(_angle)));
 //BA.debugLineNum = 173;BA.debugLine="Dim length As Float = Radius - 0.3 * IndicatorLen";
_length = (float) (_radius-0.3*_indicatorlength);
 //BA.debugLineNum = 174;BA.debugLine="p.LineTo(x + length * CosD(angle), y + length * S";
_p.LineTo((float) (_x+_length*__c.CosD(_angle)),(float) (_y+_length*__c.SinD(_angle)));
 //BA.debugLineNum = 175;BA.debugLine="p.LineTo(x - (IndicatorBaseWidth-4dip) * SinD(ang";
_p.LineTo((float) (_x-(_indicatorbasewidth-__c.DipToCurrent((int) (4)))*__c.SinD(_angle)),(float) (_y+(_indicatorbasewidth-__c.DipToCurrent((int) (4)))*__c.CosD(_angle)));
 //BA.debugLineNum = 176;BA.debugLine="cvsIndicator.ClipPath( p)";
_cvsindicator.ClipPath(_p);
 //BA.debugLineNum = 177;BA.debugLine="cvsIndicator.DrawRect(cvsIndicator.TargetRect, In";
_cvsindicator.DrawRect(_cvsindicator.getTargetRect(),_indicatorcolor,__c.True,(float) (0));
 //BA.debugLineNum = 178;BA.debugLine="cvsIndicator.RemoveClip";
_cvsindicator.RemoveClip();
 //BA.debugLineNum = 179;BA.debugLine="Dim CircleRadius As Float";
_circleradius = 0f;
 //BA.debugLineNum = 180;BA.debugLine="Dim s As String";
_s = "";
 //BA.debugLineNum = 181;BA.debugLine="If GaugeType = HALF_CIRCLE Then";
if (_gaugetype==_half_circle) { 
 //BA.debugLineNum = 182;BA.debugLine="s = PrefixText.ToUpperCase";
_s = _prefixtext.toUpperCase();
 //BA.debugLineNum = 183;BA.debugLine="CircleRadius =  Radius - IndicatorLength";
_circleradius = (float) (_radius-_indicatorlength);
 }else {
 //BA.debugLineNum = 185;BA.debugLine="CircleRadius = IndicatorBaseWidth";
_circleradius = _indicatorbasewidth;
 };
 //BA.debugLineNum = 187;BA.debugLine="cvsIndicator.DrawCircle( x, y, CircleRadius,  Cen";
_cvsindicator.DrawCircle(_x,_y,_circleradius,_centercolor,__c.True,(float) (0));
 //BA.debugLineNum = 188;BA.debugLine="cvsIndicator.Invalidate";
_cvsindicator.Invalidate();
 //BA.debugLineNum = 189;BA.debugLine="mlbl.Text = s & NumberFormat2(Value, 2, 1, 1, Tru";
...
float _angle = 0f;
float _tr = 0f;
 //BA.debugLineNum = 249;BA.debugLine="Private Sub DrawTicks";
 //BA.debugLineNum = 250;BA.debugLine="Dim r1 As Int = Radius - 2dip";
_r1 = (int) (_radius-__c.DipToCurrent((int) (2)));
 //BA.debugLineNum = 251;BA.debugLine="Dim LongTick As Int = r1 - 7dip";
_longtick = (int) (_r1-__c.DipToCurrent((int) (7)));
 //BA.debugLineNum = 252;BA.debugLine="Dim ShortTick As Int = r1 - 5dip";
_shorttick = (int) (_r1-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 253;BA.debugLine="Dim NumberOfTicks As Int";
_numberofticks = 0;
 //BA.debugLineNum = 254;BA.debugLine="If GaugeType = HALF_CIRCLE Then NumberOfTicks = 1";
if (_gaugetype==_half_circle) { 
_numberofticks = (int) (10);}
else {
_numberofticks = (int) (20);};
 //BA.debugLineNum = 255;BA.debugLine="For i = 0 To NumberOfTicks";
{
final int step6 = 1;
final int limit6 = _numberofticks;
_i = (int) (0) ;
for (;_i <= limit6 ;_i = _i + step6 ) {
 //BA.debugLineNum = 256;BA.debugLine="Dim thickness, r As Int";
_thickness = 0;
_r = 0;
 //BA.debugLineNum = 257;BA.debugLine="Dim angle As Float = i * AngleRange / NumberOfTi";
_angle = (float) (_i*_anglerange/(double)_numberofticks+_angleoffset);
 //BA.debugLineNum = 258;BA.debugLine="If i Mod 5 = 0 Then";
if (_i%5==0) { 
 //BA.debugLineNum = 259;BA.debugLine="thickness = 3dip";
_thickness = __c.DipToCurrent((int) (3));
 //BA.debugLineNum = 260;BA.debugLine="r = LongTick";
_r = _longtick;
 //BA.debugLineNum = 261;BA.debugLine="Dim tr As Float = r - 12dip";
_tr = (float) (_r-__c.DipToCurrent((int) (12)));
 //BA.debugLineNum = 262;BA.debugLine="cvsGauge.DrawTextRotated(NumberFormat(MinValue";
_cvsgauge.DrawTextRotated(ba,__c.NumberFormat(_minvalue+_i/(double)_numberofticks*(_maxvalue-_minvalue),(int) (1),(int) (0)),(float) (_x+_tr*__c.CosD(_angle)),(float) (_y+_tr*__c.SinD(_angle)),_xui.CreateDefaultFont((float) (10)),_textcolor,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"),(float) (_angle+90));
 }else {
 //BA.debugLineNum = 265;BA.debugLine="thickness = 1dip";
_thickness = __c.DipToCurrent((int) (1));
 //BA.debugLineNum = 266;BA.debugLine="r = ShortTick";
_r = _shorttick;
 };
 //BA.debugLineNum = 268;BA.debugLine="cvsGauge.DrawLine(x + r * CosD(angle), y + r * S";
_cvsgauge.DrawLine((float) (_x+_r*__c.CosD(_angle)),(float) (_y+_r*__c.SinD(_angle)),(float) (_x+_r1*__c.CosD(_angle)),(float) (_y+_r1*__c.SinD(_angle)),_textcolor,(float) (_thickness));
 }
};
 //BA.debugLineNum = 270;BA.debugLine="End Sub";
return "";
}
public String  _drawticks1() throws Exception{
int _r1 = 0;
int _longtick = 0;
int _shorttick = 0;
int _numberofticks = 0;
...
int _r = 0;
float _angle = 0f;
 //BA.debugLineNum = 146;BA.debugLine="Private Sub DrawTicks1";
...
_r = _longtick;
 ...
 //BA.debugLineNum = 159;BA.debugLine="thickness = 1dip";
_thickness = __c.DipToCurrent((int) (1));
 //BA.debugLineNum = 160;BA.debugLine="r = ShortTick";
_r = _shorttick;
 };
 //BA.debugLineNum = 162;BA.debugLine="cvsGauge.DrawLine(x + r * CosD(angle), y + r * S";
...
public float  _getcurrentvalue() throws Exception{
 //BA.debugLineNum = 219;BA.debugLine="Public Sub getCurrentValue As Float";
 //BA.debugLineNum = 220;BA.debugLine="Return mCurrentValue";
...
_mcallback = _callback;
 //BA.debugLineNum = 46;BA.debugLine="mRanges.Initialize";
_mranges.Initialize();
...
float _newvalue = 0f;
 //BA.debugLineNum = 214;BA.debugLine="Public Sub setCurrentValue (v As Float)";
 //BA.debugLineNum = 215;BA.debugLine="Dim NewValue As Float = Min(MaxValue, Max(MinValu";
_newvalue = (float) (__c.Min(_maxvalue,__c.Max(_minvalue,_v)));
 //BA.debugLineNum = 216;BA.debugLine="AnimateValueTo(NewValue)";
_animatevalueto(_newvalue);
 //BA.debugLineNum = 217;BA.debugLine="End Sub";
return "";
}
public String  _setminandmax(float _newminvalue,float _newmaxvalue) throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Public Sub SetMinAndMax(NewMinValue As Float, NewM";
 //BA.debugLineNum = 94;BA.debugLine="MinValue = NewMinValue";
_minvalue = _newminvalue;
 //BA.debugLineNum = 95;BA.debugLine="MaxValue = NewMaxValue";
_maxvalue = _newmaxvalue;
 //BA.debugLineNum = 96;BA.debugLine="DrawBackground";
_drawbackground();
...
anywheresoftware.b4a.samples.serial.gauge._gaugerange _r = null;
 //BA.debugLineNum = 196;BA.debugLine="Public Sub SetRanges(Ranges As List)";
 //BA.debugLineNum = 197;BA.debugLine="mRanges = Ranges";
_mranges = _ranges;
 //BA.debugLineNum = 198;BA.debugLine="For Each r As GaugeRange In Ranges";
{
...
_r = (anywheresoftware.b4a.samples.serial.gauge._gaugerange)(group2.Get(index2));
 //BA.debugLineNum = 199;BA.debugLine="r.Color = Bit.And(0x00ffffff, r.Color)";
_r.Color /*int*/  = __c.Bit.And((int) (0x00ffffff),_r.Color /*int*/ );
 //BA.debugLineNum = 200;BA.debugLine="r.Color = Bit.Or(0x88000000, r.Color)";
_r.Color /*int*/  = __c.Bit.Or((int) (0x88000000),_r.Color /*int*/ );
 }
};
 //BA.debugLineNum = 202;BA.debugLine="DrawBackground";
_drawbackground();
...
public float  _valuefromtimeeaseinout(float _time,float _start,float _changeinvalue,int _duration) throws Exception{
 //BA.debugLineNum = 239;BA.debugLine="Private Sub ValueFromTimeEaseInOut(Time As Float,";
 //BA.debugLineNum = 240;BA.debugLine="Time = Time / (Duration / 2)";
_time = (float) (_time/(double)(_duration/(double)2));
 //BA.debugLineNum = 241;BA.debugLine="If Time < 1 Then";
if (_time<1) { 
 //BA.debugLineNum = 242;BA.debugLine="Return ChangeInValue / 2 * Time * Time * Time *";
if (true) return (float) (_changeinvalue/(double)2*_time*_time*_time*_time+_start);
 }else {
 //BA.debugLineNum = 244;BA.debugLine="Time = Time - 2";
_time = (float) (_time-2);
 //BA.debugLineNum = 245;BA.debugLine="Return -ChangeInValue / 2 * (Time * Time * Time";
...
public float  _valuetoangle(float _value) throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Private Sub ValueToAngle (Value As Float) As Float";
 //BA.debugLineNum = 193;BA.debugLine="Return (Value - MinValue) / (MaxValue - MinValue)";
