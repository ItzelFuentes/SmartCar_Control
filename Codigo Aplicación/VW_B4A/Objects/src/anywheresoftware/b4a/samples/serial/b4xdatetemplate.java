...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "anywheresoftware.b4a.samples.serial.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", anywheresoftware.b4a.samples.serial.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public anywheresoftware.b4a.samples.serial.b4xdialog _mdialog = null;
...
_mdialog = new anywheresoftware.b4a.samples.serial.b4xdialog();
...
public ResumableSub_Show(anywheresoftware.b4a.samples.serial.b4xdatetemplate parent,anywheresoftware.b4a.samples.serial.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
anywheresoftware.b4a.samples.serial.b4xdatetemplate parent;
